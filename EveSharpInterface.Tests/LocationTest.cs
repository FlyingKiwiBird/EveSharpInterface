...
namespace EveSharpInterface.Tests
{
  ...
  public class LocationTest
  {
    ...
    public void GetLocationTest()
    {
      ...
      characterTask.Wait();
      GetCharacterLocation gcl = new GetCharacterLocation(_authorization, characterTask.Result);
    ...
    public void GetOnlineTest()
    {
      var characterTask = _authorization.GetAuthCharacterId();
      characterTask.Wait();
      GetOnlineStatus online = new GetOnlineStatus(_authorization, characterTask.Result);
